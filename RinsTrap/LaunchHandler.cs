...
namespace RinsTrap
{
    public static class LaunchHandler
    {
        ...
        public static void LaunchBackgroundUpdater()
        {
            ...
            App.Bootstrapper = new Bootstrapper(launchMode)
            {
                MutexNamePrefix = "RinsTrap-BackgroundUpdater",
            ...
            Task.Run(() =>
            {
                ...
                using (EventWaitHandle handle = new EventWaitHandle(false, EventResetMode.AutoReset, "RinsTrap-BackgroundUpdaterKillEvent"))
                    handle.WaitOne();
