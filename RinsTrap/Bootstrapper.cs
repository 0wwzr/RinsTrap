...
using RinsTrap.RobloxInterfaces;
...
namespace RinsTrap
{
    public class Bootstrapper
    {
        ...
        private async Task<bool> CheckForUpdates()
        {
            ...
            {
                App.Logger.WriteLine(LOG_IDENT, $"More than one RinsTrap instance running, aborting update check");
                return false;
            }
            ...
            SetStatus(Strings.Bootstrapper_Status_UpgradingRinsTrap);

            try
            {
#if DEBUG_UPDATER
                string downloadLocation = Path.Combine(Paths.TempUpdates, "RinsTrap.exe");
                ...
                var asset = releaseInfo.Assets!
                    ...
                    .FirstOrDefault() ?? releaseInfo.Assets![0];
