...
using RinsTrap.UI.Elements.Bootstrapper;
using RinsTrap.UI.Elements.Dialogs;

namespace RinsTrap.UI
{
    static class Frontend
    {
        ...
        public static void ShowPlayerErrorDialog(bool crash = false)
        {
            ...
            ShowMessageBox(Strings.Dialog_PlayerError_FailedLaunch, MessageBoxImage.Error);
        }
        ...
        private static IBootstrapperDialog GetCustomBootstrapper()
        {
            ...
            catch (Exception ex)
            {
                ...
                if (!App.LaunchSettings.QuietFlag.Active)
                    ShowMessageBox(string.Format(Strings.CustomTheme_Errors_SetupFailed, ex.Message, "RinsTrap"), MessageBoxImage.Error); // NOTE: RinsTrap is the theme name
        ...
        public static void ShowBalloonTip(string title, string message, System.Windows.Forms.ToolTipIcon icon = System.Windows.Forms.ToolTipIcon.None, int timeout = 5)
        {
            ...
            {
                Icon = Properties.Resources.IconRinsTrap,
