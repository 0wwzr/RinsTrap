...
namespace RinsTrap.Extensions
{
    static class BootstrapperIconEx
    {
        public static IReadOnlyCollection<BootstrapperIcon> Selections => new BootstrapperIcon[]
        {
            ...
            BootstrapperIcon.IconRinsTrapClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconRinsTrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconRinsTrap => Properties.Resources.IconRinsTrap,
                ...
                BootstrapperIcon.IconRinsTrapClassic => Properties.Resources.IconRinsTrapClassic,
                _ => Properties.Resources.IconRinsTrap
            };
        }
    }
}
